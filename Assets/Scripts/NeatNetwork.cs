...
public class NeatNetwork
{
    ...
    private NeatGenome CreateInitialGenome(int inp, int outp, int hid)
    {
        ...
        ConGene newCon1 = new ConGene(0, 3, Random.Range(0f, 1f), true, 6);
        newConGenes.Add(newCon1);
        ConGene newCon2 = new ConGene(0, 2, Random.Range(0f, 1f), true, 2);
        newConGenes.Add(newCon2);
        
        ConGene newCon5 = new ConGene(0, 1, Random.Range(0f, 1f), true, 7);
        newConGenes.Add(newCon5);
        ConGene newCon6 = new ConGene(2, 3, Random.Range(0f, 1f), true, 3);
        newConGenes.Add(newCon6);
